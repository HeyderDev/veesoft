...
// NOTA: Login puramente visual/superficial para capturas de pantalla.
// No está conectado a ninguna ruta de autenticación real. Ver conversación
// de sesión: se eliminará una vez tomadas las capturas.
