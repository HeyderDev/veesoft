...
class PurchaseRequestController extends BaseApiController
{
    ...
    {
        $requests = $this->purchaseRequestService->list();
    ...
    public function show(int $purchaseRequest)
    {
        return $this->successResponse($this->purchaseRequestService->getDetail($purchaseRequest));
    }
